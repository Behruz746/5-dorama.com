...
function BiographyMPage() {
  ...
  return (
    <div className="BiographyMPage w-full page catigoriyPage">
      <div className="container">
        <div className="popularNow__body">
          <h1 className="popularNow__title title">Биография</h1>
          <div
            className={`${
