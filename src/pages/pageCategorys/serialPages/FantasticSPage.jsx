...
function FantasticSPage() {
  ...
  return (
    <div className="FantasticSPage w-full page catigoriyPage">
      <div className="container">
        <div className="popularNow__body">
          <h1 className="popularNow__title title">Фантастика</h1>
          <div
            className={`${
